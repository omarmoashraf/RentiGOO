...
function Step1Card2() {
  return (
    <Card
      color=""
      variant="gradient"
      className="w-full max-w-[20rem] border-0 shadow-none"
    >
      <CardHeader
        floated={false}
        shadow={false}
      ...
      <CardBody className="p-0">
        <h1 className="text-start text-black text-xl pb-3">What's Included</h1>
        <ul className="flex flex-col gap-4 align-items-end">
          <li className="flex items-center gap-0">
            ...
            <Typography className="font-normal text-gray-700 text-start">
              Unlimited mileage
            </Typography>
          </li>
          <li className="flex items-center gap-0">
