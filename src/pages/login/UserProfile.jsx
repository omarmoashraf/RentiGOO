        ...
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="rounded-lg border shadow-sm bg-white sticky top-24 p-6 text-center space-y-4 dark:bg-dark-background">
              ...
              <div className="border-t pt-3 space-y-3 text-left">
                <div className="flex justify-between text-sm dark:text-dark-header_text">
                  ...
                  <span className="font-medium dark:text-dark-secondary_text">
                    January 2023
                  </span>
                </div>
                <div className="flex justify-between text-sm dark:text-dark-header_text">
          ...
          <div className="lg:col-span-3 space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-lg border shadow-sm bg-white p-6 dark:bg-dark-background">
                    <div className="flex justify-between items-center mb-4">
                      <div>
                        <h3 className="font-semibold dark:text-dark-header_text">
                    ...
                    <div className="grid gap-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Mail
                            className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-dark-secondary_text text-gray-600"
                            size={16}
                          />
                          <input
                            id="email"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Phone
                            className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-dark-secondary_text text-gray-400"
                            size={16}
                          />
                          <input
                            id="phone"
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <Calendar
                            className="absolute left-3 top-1/2 -translate-y-1/2 dark:text-dark-header_text text-gray-400"
                            size={16}
                          />
                          <input
                            type="date"
                  ...
                  <div className="rounded-lg border shadow-sm bg-white p-6 dark:bg-dark-background">
                    <div className="flex flex-col space-y-1.5 mb-4">
                      <h3 className="font-semibold flex items-center gap-2 dark:text-dark-header_text">
                        <Shield className="w-5 h-5 text-blue-500" /> Driver's
                        License
                      </h3>
                      <p className="text-sm text-gray-600 dark:text-dark-secondary_text">
                      ...
                      {notifications.map((notif) => (
                        ...
                        >
                          <div className="space-y-0.5">
                            <label className="text-sm font-medium dark:text-dark-header_text">
                              {notif.label}
                            </label>
                            <p className="text-sm text-gray-500 dark:text-dark-secondary_text">
                              {notif.desc}
            ...
            ${
              notif.checked
                ? "bg-blue-500"
                : "bg-gray-300 dark:bg-dark-secondary_text"
            }`}
                          >
                            <span
                  ...
                  <div className="rounded-lg border p-6 shadow-sm">
                    ...
                    <div className="mt-4 space-y-2">
                      ...
                      <div className="flex justify-between p-4 dark:bg-dark-background bg-gray-100 rounded-lg">
                        ...
                        <button className="text-sm px-2 py-1 bg-gray-200 rounded-md">
                          Revoke
                        </button>
                      </div>
                  ...
                  <div className="rounded-lg border bg-card text-card-foreground shadow-sm border-border">
                    <div className="flex flex-col space-y-1.5 p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className="font-bold leading-none tracking-tight dark:text-dark-header_text">
                            Payment Methods
                          </h3>
                          <p className="text-sm text-gray-600 dark:text-dark-secondary_text">
             ...
             bg-blue-600 text-white hover:bg-blue-800 shadow-sm"
                    ...
                    <div className="p-6 pt-0 space-y-4">
                      ...
                      <div className="p-4 rounded-lg border-2 border-blue-500 hover:border-blue-600 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          {/* Card Info */}
                          <div>
                            <p className="font-medium text-foreground dark:text-dark-header_text">
                  ...
                  <div className="rounded-lg border bg-card text-card-foreground shadow-sm border-border">
                    <div className="flex flex-col space-y-1.5 p-6">
                      <h3 className="font-semibold leading-none tracking-tight dark:text-dark-header_text">
                        Billing History
                      </h3>
                      <p className="text-sm text-muted-foreground dark:text-dark-secondary_text ">
                    ...
                    <div className="p-6 pt-0 space-y-3 ">
                      {[
                        ...
                        <div
                          key={idx}
                          className="flex items-center justify-between p-3 bg-blue-gray-50 rounded-lg dark:bg-dark-background"
                        >
                          <div>
                            <p className="font-medium text-foreground dark:text-dark-header_text">
                              {txn.title}
                          ...
                          <div className="text-right">
                            <p className="font-semibold text-foreground dark:text-dark-Buttons">
                              {txn.amount}
                            </p>
                            <span className="inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs bg-green-100 text-green-700">
                              Paid
                            </span>
                          </div>
                        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mt-6 ">
                    ...
                    <div className="rounded-lg border shadow-sm p-6 flex items-center gap-3 bg-white dark:bg-dark-background">
                      ...
                      <div>
                        <p className="text-2xl font-bold text-gray-800 dark:text-dark-secondary_text">
                          24
                        </p>
                        <p className="text-sm text-gray-500 dark:text-dark-header_text">
                          Total Rentals
                        </p>
                      </div>
                    </div>
