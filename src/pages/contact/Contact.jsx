      ...
      <div className="header text-center bg-light-background dark:bg-dark-background mb-10 p-4">
        ...
        <p className="text-gray-600 text-2xl">
          ...
          <span className="block mt-4">
            Our friendly team is available 24/7 to assist you with all your car
            rental needs.
          </span>
        </p>
      </div>
          ...
          >
            <CardBody className="text-center">
              <div className="mb-2 flex flex-col items-center">
                {card.icon}
                <Typography color="blue-gray" className="text-xl font-bold text-light-primary_text dark:text-dark-header_text">
                  {card.title}
                </Typography>
              </div>
              <Typography
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <label htmlFor="name" className="text-sm font-medium dark:text-dark-secondary_text">
                            Full Name *
                          </label>
                          <input
                            id="name"
                            ...
                            required
                            className="flex h-9 w-full bg-light-background dark:bg-dark-background dark:text-dark-header_text rounded-md border px-3 py-1 text-sm border-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-400"
                          />
                        </div>
                        ...
                        <div className="space-y-2">
                          <label
                            htmlFor="phone"
                            className="text-sm font-medium dark:text-dark-secondary_text "
                          >
                            Phone Number *
                          </label>
                          <input
                      ...
                      <div className="space-y-2">
                        <label htmlFor="email" className="text-sm font-medium dark:text-dark-secondary_text">
                          Email Address *
                        </label>
                        <input
                          id="email"
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          className="flex w-full rounded-md bg-light-background dark:bg-dark-background dark:text-dark-header_text border px-3 py-2 text-base border-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-blue-400 resize-none"
                        ></textarea>
                      </div>
